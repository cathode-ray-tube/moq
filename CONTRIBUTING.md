...
- **Wire**: any change to what a peer observes, encoding or behavior, and the draft under `drafts/` updated with it.
...
Rust doctests, Loom, drill sensitivity, and all five fuzz targets (five minutes
