...
- The clamp reads the rendition's advertised flush span from [Jitter
  clock](/quest/m0/jitter-flush-clock.md), which #3513 landed as the
...
- [Jitter clock](/quest/m0/jitter-flush-clock.md) - the advertised jitter the clamp reads; #3513 landed the flush span, this is its clock-based follow-on
