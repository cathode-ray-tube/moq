...
Scheduling a /plan-quests session is a good idea if the plan/goal is unclear.
...
- Repeat for at most a few cycles, backing out if substantial issues are raised.
